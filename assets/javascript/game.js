// Creating a geography wordGuessGame object that will house all of our logic and variables.
var wordGuessGame = {

  // Object of all geography words along with a picture of the place
  wordsToPick: {
    serbia: {
      picture: "Belgrade-Serbia.png"
    },
    nicaragua: {
      picture: "Nicaragua.jpg"
    },
    tokyo: {
      picture: "tokyo.jpg"
    },
    singapore: {
      picture: "singapore.jpg"
    },
    indonesia: {
      picture: "indonesia.jpg"
    },
    italy: {
      picture: "italy.jpg"
    },
    instanbul: {
      picture: "instanbul.jpg"
    },
    berkeley: {
      picture: "berkeley.jpg"
    },
    chicago: {
      picture: "chicago.jpg"
    },
    losangeles: {
      picture: "los-angeles.jpg"
    },
    whittier: {
      picture: "whittier.jpg"
    }
  },
  ...
  // This function monitors what happens when the user makes an incorrect guess (that they haven't guessed before).
  ...
  // This function monitors what happens if the user makes a successful guess.
  ...
  // For example, if we are trying to guess "singapore", it might display "sin_a_p_re".
